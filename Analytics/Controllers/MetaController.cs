...
namespace Analytics.Controllers
{
    ...
    public class MetaController : Controller
    {
        ...
        {
            string cmdText = "select Attribute_ID, Attribute_Name, Entity_ID, Entity_Name, Attribute_DBAEntity_ID, Attribute_DBAEntity_Name from meta.vRepo_viw_SYSTEM_SCHEMA_ATTRIBUTES a";
            var data = DataAccess.SqlHelper.ExecuteDataTableSqlDA(connectionString, cmdText);
            var entities = data.Tables[0];
            return JsonConvert.SerializeObject(entities);
        }
